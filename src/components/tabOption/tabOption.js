...
export default function Taboption({active ,setActive}) {
  return (
    <div className='tab-option'>
      <div className='max-width option-wrapper'>
           {tabs.map((tab)=> {
            ...
            style={{backgroundColor : `${active === tab.name?tab.backdrop : ""}`}}
            >
         <img className='tab-img' alt='{tab.name}' src={active=== tab.name ? tab.active_img : tab.nonactive_img}
         />
            </div>
